...
hPlt = plot([thresh,thresh],[1,numel(d)],'--r','LineWidth',2);
    ...
    function ChFrame(hObj)
        ...
        hHist.Data = stack(:,:,handles.curFrame);
    end

hFig = stackfig(stack>thresh,'frameupdate_fn',@ChFrame,'Colormap','gray','CLim',[0,1]);
...
set(hFig,'CloseRequestFcn',@CloseRq);
